...
import com.example.noteappkhaled.databinding.SimpleNoteItemBinding
...
class SimpleListAdapter : RecyclerView.Adapter<SimpleListAdapter.SimpleListViewHolder>() {
    ...
    inner class SimpleListViewHolder(val binding: SimpleNoteItemBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SimpleListViewHolder {
        return SimpleListViewHolder(SimpleNoteItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
